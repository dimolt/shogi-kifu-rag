...
def test_local_settings_default_values():
    ...
    # Assert
    # Note: yaneuraou_path and yaneuraou_options may be set from
    # environment variables. We focus on checking the folder-related
    # paths that changed due to folder reorganization
